...
showUILearning=false; % state whether display UI when learning
global showProgress; %show progress indicator when training
showProgress=true;
...
%set penalty for state that leads out of map (ignores them)
